...
export const destinations = [
  {
    ...
    description: 'نبض الفن والثقافة الأوروبية مع برنامج متنوع بين الأعمال والترفيه.',
  ...
  {
    name: 'القاهرة - مصر',
    description: 'رحلة تاريخية حول أهرامات الجيزة مع ورشات لبناء فرق العمل المتميزة.',
  ...
  {
    name: 'إسطنبول - تركيا',
    description: 'ملتقى الشرق والغرب مع جولات في الأسواق العثمانية ورحلات بحرية.',
  ...
  },
  {
    ...
    description: 'وجهة مستقبلية تجمع بين الأعمال والرفاهية مع تجارب صحراوية مثيرة.',
