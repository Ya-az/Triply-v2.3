          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 text-white/75 dark:text-dark-text-secondary group">
                ...
                <a href="mailto:iwq32j@gmail.com" className="hover:text-white dark:hover:text-dark-text-primary transition-colors">iwq32j@gmail.com</a>
              </li>
              <li className="flex items-start gap-3 text-white/75 dark:text-dark-text-secondary group">
                <svg className="w-5 h-5 text-triply-mint dark:text-triply-teal flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <a href="tel:+966560578060" className="hover:text-white dark:hover:text-dark-text-primary transition-colors">+966 56 057 8060</a>
              </li>
              <li className="flex items-start gap-3 text-white/75 dark:text-dark-text-secondary group">
                <svg className="w-5 h-5 text-triply-mint dark:text-triply-teal flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
